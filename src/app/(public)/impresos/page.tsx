    ...
    return (
        <main className="bg-web">
            ...
            <section className="container mx-auto max-w-[1100px] px-4 py-8 sm:px-6 sm:py-10 md:px-8 md:py-12 md:pb-[100px]">
                <h1 className="font-basic-sans mb-4 text-[32px] font-bold text-negro sm:text-[40px] md:text-[48px]">IMPRESO</h1>
                <p className="font-basic-sans mb-6 text-[16px] leading-[20px] text-negro sm:text-[17px] sm:leading-[21px] md:text-[18px] md:leading-[22px]">
